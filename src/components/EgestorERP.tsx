...
const EgestorERP = () => {
  ...
  const egestorLink = "https://www.egestor.com.br/afl/13624";
    ...
    <section className="py-16 bg-white overflow-hidden">
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-8 lg:gap-12 mb-10">
          ...
          <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0 animate-fadeIn">
          ...
          <div className="md:w-1/2 rounded-xl overflow-hidden shadow-xl animate-fadeIn">
