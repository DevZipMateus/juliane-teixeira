...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sobre - Juliane Teixeira Consultoria Empresarial</title>
        <meta name="description" content="Conheça a Juliane Teixeira Consultoria Empresarial. Com mais de 15 anos de experiência, oferecemos soluções práticas e estratégicas para o crescimento sustentável do seu negócio." />
        <meta name="keywords" content="sobre consultoria empresarial, experiência empresarial, soluções estratégicas, Juliane Teixeira história" />
        <meta name="robots" content="index, follow" />
        
        <meta property="og:title" content="Sobre - Juliane Teixeira Consultoria Empresarial" />
        <meta property="og:description" content="Conheça nossa história e valores. Mais de 15 anos oferecendo consultoria empresarial com foco em resultados reais e crescimento sustentável." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://julianeteixeira.com.br/about" />
        ...
        <meta name="twitter:title" content="Sobre - Juliane Teixeira Consultoria Empresarial" />
        <meta name="twitter:description" content="Conheça nossa história e valores. Consultoria empresarial com foco em resultados reais." />
        <meta name="twitter:image" content="https://julianeteixeira.com.br/lovable-uploads/598581a5-235d-45d1-88d0-5cc9a9ae9f78.png" />
        
        <link rel="canonical" href="https://julianeteixeira.com.br/about" />
      </Helmet>
        ...
        <main>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className={`text-lg text-gray-600 mx-auto mb-6 max-w-3xl opacity-0 ${isVisible ? 'animate-slideDown delay-200' : ''}`}>
                  Com mais de 15 anos de experiência, oferecemos consultoria empresarial especializada 
                  em soluções práticas para empresas de todos os portes, com foco na satisfação dos nossos clientes.
                </p>
          ...
          <section className="py-12 md:py-16 bg-white">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-bold mb-4 leading-tight">
                  Pronto para transformar a <span className="text-scarlet-700">gestão</span> da sua empresa?
                </h2>
                <p className="text-lg text-gray-600 mb-6 max-w-3xl mx-auto">
                  Entre em contato conosco hoje mesmo e descubra como podemos ajudar o seu negócio a crescer com soluções empresariais personalizadas.
                </p>
                <Link to="/contact">
                  <Button variant="default" size="lg" className="rounded-full">
